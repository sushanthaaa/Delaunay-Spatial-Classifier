...
| 4 | `4_decision_boundaries.png` | DT + Voronoi decision regions |
...
| 7 | `query_1_locate_triangle.png` | Query points (★) locate triangles via SRR |
...
> **Key Distinction:** Classification uses SRR to find the triangle—the DT is never modified. Insertion adds labeled training data and locally updates the DT.
